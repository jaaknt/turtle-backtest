...
class TestPeriodReturnIntegration:
    ...
    def test_signal_result_detailed_result(self, signal_result_with_period_data):
    ...
    def test_strategy_comparison(self, signal_result_with_period_data):
    ...
    def test_invalid_strategy_name(self, signal_result_with_period_data):
    ...
    def test_missing_period_data(self, signal_result_with_period_data):
...
class TestBackwardCompatibility:
    ...
    def test_default_strategy_parameter(self, signal_result_with_period_data):
    ...
    def test_legacy_method_signature(self, legacy_signal_result):
...
class TestStrategyDemonstration:
    ...
    def test_profit_target_vs_buy_hold(self):
