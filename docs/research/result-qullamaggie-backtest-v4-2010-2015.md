...
Run date: 2026-08-01 10:06:10 Tallinn time
...
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   1  bk50d_s16_v2.0                   366d   359   59.3   +17.07    +17.02    +8.71   +43.21   2.47    0.777    38.71   -64.50    5.1   39.5     37    4/5  ✓
   2  bk50d_s20_v2.0                   366d   178   56.2   +16.49    +16.44    +4.94   +44.22   2.23    0.682    41.13   -66.45    2.5   52.0     49    3/4  ✓
   3  bk50d_s12_v2.0                   366d   661   57.3   +13.76    +13.72    +7.20   +36.94   2.24    0.651    37.53   -62.75    9.3   32.7     27    5/6  ✓
...
- `bk50d_s16_v2.0` | `366d` — SR=0.777, Win%=59.3, Med%=+8.71, AnnMean%=+17.02, Q75%=+43.21, MaxDD%=38.71, CVaR%=-64.50, Yrs+=4/5, N=359
- `bk50d_s20_v2.0` | `366d` — SR=0.682, Win%=56.2, Med%=+4.94, AnnMean%=+16.44, Q75%=+44.22, MaxDD%=41.13, CVaR%=-66.45, Yrs+=3/4, N=178
- `bk50d_s12_v2.0` | `366d` — SR=0.651, Win%=57.3, Med%=+7.20, AnnMean%=+13.72, Q75%=+36.94, MaxDD%=37.53, CVaR%=-62.75, Yrs+=5/6, N=661
...
Ranking gate sweep: QullamaggieRanking ≥ 40
   ...
   #  Entry Signal                      Exit     N   Win%    Mean%  AnnMean%     Med%     Q75%     PF  Sortino   MaxDD%    CVaR%   F/mo  RkAvg  RkMed   Yrs+  C
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   1  bk50d_s20_v2.0 R≥40              366d   116   56.9   +17.92    +17.86    +9.62   +47.21   2.30    0.729    42.73   -66.48    1.6   61.0     60    1/2   
   2  bk50d_s16_v2.0 R≥40              366d   150   56.7   +16.27    +16.22   +10.71   +46.37   2.24    0.677    42.02   -68.77    2.1   58.8     57    3/4  ✓
   3  bk50d_s12_v2.0 R≥40              366d   194   57.2   +15.27    +15.22   +10.56   +43.42   2.16    0.626    41.98   -70.79    2.7   55.6     52    4/5  ✓

Valid combinations: 3  |  Consistent: 2
```
...
- `bk50d_s16_v2.0 R≥40` | `366d` — SR=0.677, Win%=56.7, Med%=+10.71, AnnMean%=+16.22, Q75%=+46.37, MaxDD%=42.02, CVaR%=-68.77, Yrs+=3/4, N=150
- `bk50d_s12_v2.0 R≥40` | `366d` — SR=0.626, Win%=57.2, Med%=+10.56, AnnMean%=+15.22, Q75%=+43.42, MaxDD%=41.98, CVaR%=-70.79, Yrs+=4/5, N=194
