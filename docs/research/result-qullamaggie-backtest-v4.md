...
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   ...
   3  bk50d_s12_v2.0                   366d  1008   62.3   +36.68    +36.57   +14.68   +55.44   4.71    1.857    38.48   -60.61   15.3   37.3     33    5/5  ✓
...
- `bk50d_s12_v2.0` | `366d` — SR=1.857, Win%=62.3, Med%=+14.68, AnnMean%=+36.57, Q75%=+55.44, MaxDD%=38.48, CVaR%=-60.61, Yrs+=5/5, N=1008
...
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   ...
   2  bk50d_s12_v2.0 R≥50              366d   254   63.8   +53.42    +53.24   +25.41   +79.64   5.99    2.494    45.12   -67.70    3.8   67.2     64    4/4  ✓
   3  bk50d_s12_v2.0 R≥40              366d   398   62.6   +50.93    +50.76   +21.90   +71.93   5.85    2.449    42.77   -63.50    6.0   58.6     57    5/5  ✓
   ...
   6  bk50d_s16_v2.0 R≥50              366d   230   61.3   +53.77    +53.59   +23.71   +84.64   5.65    2.404    45.73   -69.00    3.5   68.3     66    4/4  ✓
   7  bk50d_s12_v2.0 R≥45              366d   297   63.3   +51.56    +51.39   +21.75   +75.32   5.71    2.384    44.51   -66.96    4.5   64.2     64    4/4  ✓
...
- `bk50d_s12_v2.0 R≥50` | `366d` — SR=2.494, Win%=63.8, Med%=+25.41, AnnMean%=+53.24, Q75%=+79.64, MaxDD%=45.12, CVaR%=-67.70, Yrs+=4/4, N=254
- `bk50d_s12_v2.0 R≥40` | `366d` — SR=2.449, Win%=62.6, Med%=+21.90, AnnMean%=+50.76, Q75%=+71.93, MaxDD%=42.77, CVaR%=-63.50, Yrs+=5/5, N=398
...
- `bk50d_s12_v2.0 R≥45` | `366d` — SR=2.384, Win%=63.3, Med%=+21.75, AnnMean%=+51.39, Q75%=+75.32, MaxDD%=44.51, CVaR%=-66.96, Yrs+=4/4, N=297
...
────────────────────────────────────────────────────────────────────────
bk50d_s12_v2.0               40      1383       547        836     60.4%
bk50d_s12_v2.0               45      1383       401        982     71.0%
bk50d_s12_v2.0               50      1383       343       1040     75.2%
bk50d_s16_v2.0               40       891       456        435     48.8%
bk50d_s16_v2.0               45       891       370        521     58.5%
bk50d_s16_v2.0               50       891       307        584     65.5%
bk50d_s20_v2.0               40       534       387        147     27.5%
bk50d_s20_v2.0               45       534       321        213     39.9%
bk50d_s20_v2.0               50       534       275        259     48.5%
```
