...
| **Portfolio backtest errors** | Lower `--min-signal-ranking`, or lower `--position-size-pct` if entries are being skipped for lack of cash | Ensure signals exist for date range, validate benchmark data (SPY/QQQ) |
