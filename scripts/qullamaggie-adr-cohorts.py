#!/usr/bin/env python3
"""
ROC252 cohort analysis for bk50d_s20_tr20_v1.2_roc100, bk50d_s15_tr20_v1.2_roc100 (366d hold).
...
RESULT_PATH = Path(__file__).parent.parent / "docs" / "research" / "result-qullamaggie-roc-cohorts.md"
