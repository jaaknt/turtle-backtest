...
COHORTS: dict[str, list[tuple[float, float]]] = {
    "adr": [
        (0.000, 0.010), (0.010, 0.020), (0.020, 0.025), (0.025, 0.030),
        (0.030, 0.035), (0.035, 0.040), (0.040, 0.045), (0.045, 0.050),
        (0.050, 0.070), (0.080, float("inf")),
    ],
    "comp": [
        (float("-inf"), 0.5), (0.5, 0.7), (0.7, 0.8), (0.8, 0.9),
        (0.9, 1.0), (1.0, 1.3), (1.3, float("inf")),
    ],
    "rsi": [
        (0.0, 20.0), (20.0, 40.0), (40.0, 50.0), (50.0, 60.0), (60.0, 70.0),
        (70.0, 75.0), (75.0, 80.0), (80.0, 90.0), (90.0, 100.001),
    ],
    "price": [
        (0.0, 5.0), (5.0, 10.0), (10.0, 20.0), (20.0, 50.0), (50.0, 100.0),
        (100.0, 250.0), (250.0, 700.0), (700.0, 2000.0), (2000.0, float("inf")),
    ],
    "vsurge": [
        (0.00, 0.70), (0.70, 0.80), (0.80, 0.90), (0.90, 1.00), (1.00, 1.10),
        (1.10, 1.20), (1.20, 1.30), (1.30, 1.40), (1.40, 1.60), (1.60, 2.00),
        (2.00, 3.00), (3.00, 4.00), (4.00, 6.00), (6.00, float("inf")),
    ],
    "roc": [
        (float("-inf"), -0.20), (-0.20, 0.00), (0.00, 0.20), (0.20, 0.40),
        (0.40, 0.60), (0.60, 0.80), (0.80, 1.00), (1.00, 1.20), (1.20, 1.40),
        (1.40, 1.60), (1.60, float("inf")),
    ],
}
...
def fmt_decile_row(label: str, pred_p: float, m: dict) -> str:
    ...
    return (
        f"{label:<10}  {pred_p:>6.1f}  {m['n']:>5}  {m['med']:>+7.2f}  {m['mean']:>+7.2f}  "
